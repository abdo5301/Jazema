...
class MerchantProductCategoryController extends SystemController
{
    ...
    public function index(Request $request){
        ...
        if($request->isDataTable){
            $eloquentData = MerchantProductCategory::viewData(\DataLanguage::get());
    ...
    public function create(Request $request)
    {
        ...
        $MerchantCategoryID = request('merchant_category_id');
        if($MerchantCategoryID){
            $MerchantCategoryData = MerchantCategory::findOrFail($MerchantCategoryID);
            $this->viewData['MerchantCategoryData'] = $MerchantCategoryData;
        }
    ...
    public function store(MerchantProductCategoryFormRequest $request)
    {
        ...
        $theRequest['approved_at'] = date('Y-m-d');
    ...
    public function show(MerchantProductCategory $product_category){
        ...
        $this->viewData['breadcrumb'][] = [
            'text'=> $product_category->{'name_'.\DataLanguage::get()},
        ];
