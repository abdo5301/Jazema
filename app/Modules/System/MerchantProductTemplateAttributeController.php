...
class MerchantProductTemplateAttributeController extends SystemController
{
    ...
    public function index(Request $request){
        if($request->isDataTable){
            ...
            $eloquentData = MerchantProductTemplateAttribute::select([
                'id',
            ...
            return $this->view('merchant-product-template-attribute.index',$this->viewData);
        }
    ...
    public function create()
    {
        ...
        return $this->view('merchant-product-template-attribute.create',$this->viewData);
    ...
    public function show(MerchantProductTemplateAttribute $attribute){
       // dd($tax->toArray());
        ...
        return $this->view('merchant-product-template-attribute.show',$this->viewData);
