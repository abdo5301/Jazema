...
class TempData extends Model
{
    ...
    protected $fillable = ['type','data','create_id','create_type','reviewed_id','reviewed_at','reviewed_type','reviewed_comment'];
    ...
    public static function viewData($langCode,array $additionColumn = []){
        $columns = [
            ...
            'temp_data.reviewed_type',
            'temp_data.reviewed_comment',
