                ...
                <div class="col-md-4">
                    <section id="spacing" class="card">
                        <div class="card-header">
                            <h4 class="card-title">
                                {{__('Attribute Info')}}
                                <span style="float: right;"><a class="btn btn-outline-primary"  href="javascript:void();" onclick="urlIframe('{{route('system.attributes.edit',[$result->id])}}')"><i class="fa fa-pencil"></i> {{__('Edit')}}</a></span>
                            </h4>
                                    ...
                                    <table class="table table-hover">
                                       ...
                                       <tr>
                                        ...
                                        <tr>
                                           ...
                                           <td>{{$result->is_required}}</td>
                                       </tr>
                                        <tr>
                                            <td>{{__('Item Type')}}</td>
                                            @if(!empty($result->itemType->id))
                                                <td><code><a target="_blank" href="{{route('system.item_type.show',$result->itemType->id)}}">{{$result->itemType->{'name_'.\DataLanguage::get()} }}</a></code></td>
                                                @else
                                                <td><code>--</code></td>
                                            @endif
                                        </tr>
                                        ...
                                        <div class="card-block card-dashboard table-responsive">
                                            <table style="text-align: center;" class="table table-striped table-bordered">
                                                ...
                                                @if(!empty($result->values))
                                                    @foreach($result->values()->orderBy('sort')->get() as $value)
                                                    <tr>
                                                        <td>{{$value->id}}</td>
