                        ...
                        <div class="col-md-4">
                            <section id="spacing" class="card">
                                <div class="card-header">
                                    <h4 class="card-title">
                                        {{__('Item Type Info')}}
                                        <span style="float: right;"><a class="btn btn-outline-primary"  href="javascript:void();" onclick="urlIframe('{{route('system.item_type.edit',[$result->id])}}')"><i class="fa fa-pencil"></i> {{__('Edit')}}</a></span>
                                    </h4>
                                            ...
                                            <table class="table table-hover">
                                                ...
                                                <tr>
                                                    ...
                                                    @if(!empty($result->parent->id))
                                                        <td><code>{{$result->parent->{'name_'.\DataLanguage::get()} }}</code></td>
                                                        @else
                                                        <td><code>--</code></td>
                                                    @endif
