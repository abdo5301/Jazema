                                        ...
                                        <div class="card-block card-dashboard">
                                            <div class="form-group col-sm-6 {!! formError($errors,'merchant_id',true) !!}">
                                                <div class="controls">
                                                    ...
                                                    @else
                                                        ...
                                                        @else
                                                            {!! Form::select('merchant_id',(isset($current_merchant)) ? [old('merchant_id')=>$current_merchant->{'name_'.\DataLanguage::get()}.' #ID:'.$current_merchant->id] : [__('Select Merchant')],old('merchant_id'),['style'=>'width: 100%;','class'=>'select2 form-control','onchange'=>'get_merchant_template_option()']) !!}
                                                        @endif
                                                    @endif
                                                </div>
                                            ...
                                            <div class="form-group col-sm-6{!! formError($errors,'merchant_product_category_id',true) !!}">
                                                <div class="controls">
                                                    ...
                                                    @if(isset($result->id))
                                                        {!! Form::select('merchant_product_category_id',$MerchantProductCategory,isset($result->id) ? $result->merchant_product_category_id:old('merchant_product_category_id'),['class'=>'select2 form-control','id'=>'merchant_product_category_id','onchange'=>'get_attribute()']) !!}
                                                    @else
                                                        {!! Form::select('merchant_product_category_id',$MerchantProductCategory,old('merchant_product_category_id'),['class'=>'select2 form-control','id'=>'merchant_product_category_id','onchange'=>'get_attribute()']) !!}
                                                    @endif
                                                </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="card">
                                        <div class="card-block card-dashboard">
                                            ...
                                            <div class="form-group col-sm-6{!! formError($errors,'tax_ids',true) !!}">
                                                <div class="controls">
                                                    {!! Form::label('tax', __('Tax').':') !!}
                                                    <select name="tax_ids[]" id="" class="form-control newselect2"
                                                            multiple>
                                                        <option value="">{{__('Select Tax')}}</option>
                                                        @if(!empty($tax))
                                                            @foreach($tax as $row)
                                                                <option
                                                                        @if(is_array($old_tax_ids)) @if(in_array($row['id'],$old_tax_ids)) selected
                                                                        @endif @endif
                                                            ...
                                                            @if($result->option)
                                                                ...
                                                                @foreach($result->option()->where('status','!=','deleted')->get() as $key => $row)
                                                                    ...
                                                                    <div role="tabpanel"
                                                                        ...
                                                                        {{--<div class="form-group col-sm-10{!! formError($errors,'option.'.$row['id'].'.template_option',true) !!}">--}}
                                                                        {{--<div class="controls">--}}
                                                                        {{--{!! Form::label('template_option', __('Template Option').':') !!}--}}
                                                                        {{--<div class="input-group input-group-lg">--}}
                                                                        {{--{!! Form::select('option['.$row['id'].'][template_option]',[''=>__('Select Option'),'current'=>__('Current Option'),'new'=>__('New Option')]+$current_template_option,'current',['id'=>'template_option_'.$row['id'],'class'=>'form-control template_option']) !!}--}}
                                                                        {{--</div>--}}
                                                                        {{--</div>--}}
                                                                        {{--{!! formError($errors,'option.'.$row['id'].'.template_option') !!}--}}
                                                                        {{--</div>--}}
                                                                        <div class="col-sm-10"></div>
                                                                        <input type="hidden"
                                                                        ...
                                                                        <div id="new_option">
                                                                            ...
                                                                            <div class="form-group col-sm-6{!! formError($errors,'option.'.$row['id'].'.option_min_select',true) !!}">
                                                                                <div class="controls">
                                                                                    {!! Form::label('option_min_select', __('Min Select').':') !!}
                                                                                    <div class="input-group input-group-lg">
                                                                                        {!! Form::number('option['.$row['id'].'][option_min_select]',$row['min_select'],['class'=>'form-control option_min_select']) !!}

                                                                                    </div>
                                                                                </div>
                                                                                {!! formError($errors,'option.'.$row['id'].'.option_min_select') !!}
                                                                            </div>

                                                                            <div class="form-group col-sm-6{!! formError($errors,'option.'.$row['id'].'.option_max_select',true) !!}">
                                                                                <div class="controls">
                                                                                    {!! Form::label('option_max_select', __('Max Select').':') !!}
                                                                                    <div class="input-group input-group-lg">
                                                                                        {!! Form::number('option['.$row['id'].'][option_max_select]',$row['max_select'],['class'=>'form-control option_max_select']) !!}

                                                                                    </div>
                                                                                </div>
                                                                                {!! formError($errors,'option.'.$row['id'].'.option_max_select') !!}
                                                                            </div>
                                                                ...
                                                                @foreach($current_attribute as $key=>$value)
                                                                    ...
                                                                    <div class="attribute_div_row attribute_div_row_{{$value->id}}">
                                                                        ...
                                                                        <div class="form-group col-sm-10{!! formError($errors,'attribute.'.$value->id,true) !!}">
                                                                            <div class="controls">
                                                                                {!! Form::label('attribute',$value->name) !!}
                                                                                <div class="input-group input-group-lg">
                                                                                    @if($value->type == 'text')
                                                                                        {!! Form::text('attribute['.$value->id.']',old('attribute.'.$value->id),['id'=>'attribute_'.$value->id,'class'=>'form-control']) !!}
                                                                                    @elseif($value->type == 'textarea')
                                                                                        {!! Form::textarea('attribute['.$value->id.']',old('attribute.'.$value->id),['id'=>'attribute_'.$value->id,'class'=>'form-control']) !!}
                                                                                    @elseif($value->type == 'select')
                                                                                        {!! Form::select('attribute['.$value->id.']',[''=>__('Select Attribute')]+array_column( $value->values->toArray(),'name','id'),old('attribute.'.$value->id),['id'=>'attribute_'.$value->id,'class'=>'form-control']) !!}
                                                                                    @elseif($value->type == 'multi-select')
                                                                                        <select name="attribute[{{$value->id}}][]"
                                                                                                id="" multiple
                                                                                                class="form-control newselect2">
                                                                                            <option value="">{{__('Select Attribute')}}</option>
                                                                                            @foreach($value->values as $oneval )
                                                                                                <option @if(is_array(old('attribute.'.$value->id))) @if(in_array($oneval->id,old('attribute.'.$value->id))) selected
                                                                            ...
                                                                            {!! formError($errors,'attribute.'.$value->id) !!}
                                                                        </div>
...
@section('footer')
    ...
    <script>
        ...
        function get_merchant_template_option() {
            ...
            $.get('{{route('merchant.product-template-option')}}', {'merchant_id': value}, function (out) {
...
var publicLength = $('#option_li_list li').length;
        ...
        function get_attribute() {
            var category_id = $('#merchant_product_category_id').val();
