                                        ...
                                        <div class="card-block card-dashboard">
                                            ...
                                            <div class="form-group col-sm-6{!! formError($errors,'merchant_product_category_id',true) !!}">
                                                <div class="controls">
                                                    ...
                                                    @if(isset($result->id))
                                                        {!! Form::select('merchant_product_category_id',$MerchantProductCategory,isset($result->id) ? $result->merchant_product_category_id:old('merchant_product_category_id'),['class'=>'select2 form-control','id'=>'category_id','onchange'=>'get_attribute()']) !!}
                                                    @else
                                                        {!! Form::select('merchant_product_category_id',$MerchantProductCategory,old('merchant_product_category_id'),['class'=>'select2 form-control','id'=>'category_id','onchange'=>'get_attribute()']) !!}
                                                    @endif
                                                </div>
