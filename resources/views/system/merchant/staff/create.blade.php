                                    ...
                                    <div class="card-block card-dashboard">
                                        ...
                                        <div class="form-group col-sm-6 {!! formError($errors,'merchant_id',true) !!}">
                                            <div class="controls">
                                                ...
                                                @else
                                                    @if(isset($result->id))
                                                        {!! Form::select('merchant_id',[$result->staff_group->merchant->id => $result->staff_group->merchant->{'name_'.\DataLanguage::get()}.' #ID: '.$result->staff_group->merchant_id],isset($result->id) ? $result->staff_group->merchant_id:old('merchant_id'),['class'=>'select2 form-control','readonly']) !!}
                                                    @else
