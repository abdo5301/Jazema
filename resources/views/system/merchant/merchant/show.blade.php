...
<form action="#" id="trans" onsubmit="FirstLastTransactions();return false;" >
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div id="newData" class="form-group col-sm-12">
...
@if( staffCan('merchant.merchant.change-sales',Auth::id()))

    <div class="modal fade text-xs-left" id="changeSales-modal"  role="dialog" aria-labelledby="myModalLabel33" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    ...
                    <label class="modal-title text-text-bold-600" id="myModalLabel33">{{__('Change Sales for Merchant')}}</label>
                </div>
                {!! Form::open([ 'method' => 'POST','id'=>'changeSales-form','onsubmit'=>'changeSalesPOST();return false;']) !!}
                {{Form::hidden('merchant_id',$result->id)}}
                {{Form::hidden('staff_id',$result->staff_id)}}
                <div class="modal-body">
                    <div class="card-body">
                        <div class="card-block">
                            <div class="row">
                                <div class="alert" id="addSales-alert"></div>

                                <div class="col-md-12">
                                    <fieldset class="form-group">
                                        {{ Form::label('sales_id',__('Sales Name')) }}
                                        {!! Form::select('sales_id',array_column($sales->toArray(),'name','id'),null,['class'=>'form-control']) !!}
                                    </fieldset>
                                </div>
                ...
                <div class="modal-footer">
                    <button type="submit" id="changeSales-button" class="btn btn-outline-primary btn-md">{{__('Submit')}}</button>
                </div>
                {!! Form::close() !!}
            </div>
        </div>
                                ...
                                <nav class="navbar navbar-light navbar-profile">
                                    ...
                                    <div class="collapse navbar-toggleable-xs" id="exCollapsingNavbar2">
                                        <ul class="nav navbar-nav float-xs-right">
                                            ...
                                            <li class="nav-item active">
                                                <a target="_blank" class="nav-link" href="{{route('payment.invoice.index',['merchant_id'=> $result->id])}}"><i class="fa fa-file-text"></i> {{__('Payment Invoices')}} <span class="sr-only">(current)</span></a>
                                            </li>
                                            <li class="nav-item active">
                                                <a target="_blank" class="nav-link" href="{{route('payment.transactions.list',['merchant_id'=> $result->id])}}"><i class="fa fa-file-text"></i> {{__('Transactions')}} <span class="sr-only">(current)</span></a>
                                            </li>
                                            ...
                                            @if( staffCan('system.wallet.transactions',Auth::id()))
                                            <li class="nav-item active">
                                                <a  class="nav-link" href="javascript:void(0);" data-toggle="modal" data-target="#transactions-modal"><i class="fa fa-file-text"></i> {{__('F-L-Transaction')}} <span class="sr-only">(current)</span></a>
                                            </li>
                                            @endif
                            ...
                            <div class="card-block">
                                @foreach($result->MerchantImages as $image)
                                    <div class="col-md-2 well">
                                        <img class="zoomImage" style="width:100%; height:auto;" src="{{'storage/'.asset($image->path)}}">
                                    </div>
                                @endforeach
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <section id="spacing" class="card">
                                <div class="card-header">
                                    <h4 class="card-title">
                                        {{__('Merchant Info')}}
                                        <span style="float: right;"><a class="btn btn-outline-primary"  href="javascript:void(0);" onclick="urlIframe('{{route('merchant.merchant.edit',$result->id)}}')"><i class="fa fa-pencil"></i> {{__('Edit')}}</a></span>
                                    </h4>
                                            ...
                                            <table class="table table-hover">
                                                ...
                                                @if($result->parent_id)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="{{route('merchant.merchant.show',$result->parent->id)}}" target="_blank">{{$result->parent->{'name_'.\DataLanguage::get()} }}</a>
                                                        </td>
                                                    </tr>
                                                @endif
                        ...
                        <div class="col-md-4">
                            <section id="spacing" class="card">
                                <div class="card-header">
                                    <h4 class="card-title">
                                        {{__('Category Info')}}
                                        <span style="float: right;"><a class="btn btn-outline-primary"  href="javascript:void(0);" onclick="urlIframe('{{route('merchant.category.edit',$result->category->id)}}')"><i class="fa fa-pencil"></i> {{__('Edit')}}</a></span>
                                    </h4>
                                </div>
                                <div class="card-body collapse in">
                                    <div class="card-block">
                            ...
                            <section class="card">
                                <div class="card-header">
                                    <h4 class="card-title">{{__('Last Contract')}}
                                        <span style="float: right;"><a class="btn btn-outline-primary" target="_blank" href="{{route('merchant.contract.edit',$result->contract->id)}}" ><i class="fa fa-pencil"></i> {{__('Edit')}}</a></span>
                                ...
                                <div class="card-header">
                                    <h4 class="card-title">
                                        ...
                                        <span style="float: right;">
                                            <a style="margin-bottom: 10px;" class="btn btn-outline-success"  href="javascript:void(0);" onclick="urlIframe('{{route('merchant.staff-group.index',['merchant_id'=>$result->id])}}')"><i class="fa fa-eye"></i> {{__('View Group')}}</a>
                                            <a style="margin-bottom: 10px;" class="btn btn-outline-primary"  href="javascript:void(0);" onclick="urlIframe('{{route('merchant.staff-group.create',['merchant_id'=>$result->id])}}')"><i class="fa fa-plus"></i> {{__('Add Group')}}</a>
                                            <br>
                                            <a style="margin-bottom: 10px;" class="btn btn-outline-success"  href="javascript:void(0);" onclick="urlIframe('{{route('merchant.staff.index',['merchant_id'=>$result->id])}}')"><i class="fa fa-eye"></i> {{__('View Staff')}}</a>
                                            <a style="margin-bottom: 10px;" class="btn btn-outline-primary"  href="javascript:void(0);" onclick="urlIframe('{{route('merchant.staff.create',['merchant_id'=>$result->id])}}')"><i class="fa fa-plus"></i> {{__('Add Staff')}}</a>
                                        </span>
                                    </h4>
                                                            ...
                                                            <tr class="treegrid-2{{$staffValue->id}} treegrid-parent-{{$value->id}}">
                                                                <td>
                                                                    <a target="_blank" href="{{route('merchant.staff.show',$staffValue->id)}}">
                                                                        {{$staffValue->firstname}} {{$staffValue->lastname}} <small>#ID:{{$staffValue->id}}</small>
                                                                    </a>
                                                                </td>
                                                            </tr>
                                                        @endforeach
                            ...
                            <section id="spacing" class="card">
                                <div class="card-header">
                                    <h4 class="card-title">
                                        ...
                                        <span style="float: right;"><a class="btn btn-outline-primary"  href="javascript:void(0);" onclick="urlIframe('{{route('merchant.branch.create',['merchant_id'=>$result->id])}}')"><i class="fa fa-plus"></i> {{__('Add New Branche')}}</a></span>
                                    </h4>
                            ...
                            <section id="spacing" class="card">
                                <div class="card-header">
                                    <h4 class="card-title">
                                        ...
                                        <span style="float: right;"><a class="btn btn-outline-primary"  href="javascript:void(0);" onclick="urlIframe('{{route('merchant.contract.create',['merchant_id'=>$result->id])}}')"><i class="fa fa-plus"></i> {{__('Add New Contract')}}</a></span>
                                    </h4>
                        ...
                        <div class="col-md-12">
                            <section id="spacing" class="card">
                                ...
                                <div class="card-body collapse in">
                                    <div class="card-block">
                                        <div class="table-responsive">
                                            <table class="table table-striped table-bordered" id="sub-merchants-table">
                                                <thead>
                                                    <tr>
                                                        <th>{{__('ID')}}</th>
                                                        <th>{{__('Logo')}}</th>
                            ...
                            <section id="spacing" class="card">
                                <div class="card-header">
                                    <h4 class="card-title">
                                        ...
                                        <span style="float: right;">
                                            <a style="margin-bottom: 10px;" class="btn btn-outline-primary" href="javascript:void(0);" onclick="urlIframe('{{route('merchant.product-category.index',['merchant_id'=>$result->id])}}')"><i class="fa fa-eye"></i> {{__('View Category')}}</a>
                                            <a style="margin-bottom: 10px;" class="btn btn-outline-primary" href="javascript:void(0);" onclick="urlIframe('{{route('merchant.product-category.create',['merchant_id'=>$result->id])}}')"><i class="fa fa-plus"></i> {{__('Add Product Category')}}</a>
                                            <br>
                                            <a style="margin-bottom: 10px;" class="btn btn-outline-success" href="javascript:void(0);" onclick="urlIframe('{{route('merchant.product.index',['merchant_id'=>$result->id])}}')"><i class="fa fa-eye"></i> {{__('View Product')}}</a>
                                            <a style="margin-bottom: 10px;" class="btn btn-outline-success" href="javascript:void(0);" onclick="urlIframe('{{route('merchant.product.create',['merchant_id'=>$result->id])}}')"><i class="fa fa-plus"></i> {{__('Add Product')}}</a>
                                        </span>
                                    </h4>
                                                ...
                                                @foreach($productsCategories as $key => $value)
                                                    ...
                                                    <tr class="treegrid-{{$value->id}}">
                                                        <td>
                                                            ...
                                                            @endif
                                                            <b>
                                                                <a  @if($value->approved_at == null) style="color: red;" @endif target="_blank" href="{{route('merchant.category.show',$value->id)}}">{{$value->{'name_'.\DataLanguage::get()} }}</a>
                                                            </b>
                                                        </td>
                                                        <td colspan="2">{{$value->{'description_'.\DataLanguage::get()} }}</td>
                                                    </tr>
                                                            ...
                                                            <tr class="treegrid-2{{$productValue->id}} treegrid-parent-{{$value->id}}">
                                                                <td>
                                                                    ...
                                                                    <a target="_blank" href="{{route('merchant.product-category.show',$productValue->id)}}" @if($productValue->approved_at == null) style="color: red;" @endif>
                                                                        {{$productValue->{'name_'.\DataLanguage::get()} }}
                                                                    </a>
                                                                </td>
                                                                <td>{{$productValue->price}} {{__('LE')}}</td>
                                                                <td>{{$productValue->{'description_'.\DataLanguage::get()} }}</td>
                                                            </tr>
                                                        @endforeach
                                                    @endif
    ...
    <div class="modal fade" id="modal-map" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        ...
        @section('footer')
            ...
            <script type="text/javascript">
                ...
                function changeSalesPOST(){
                    ...
                    if(isConfirm){
                        ...
                        $.post('{{route('merchant.merchant.change-sales')}}',$('#changeSales-form').serialize(),function(response){
            ...
            <script type="text/javascript">
                ...
                function FirstLastTransactions(){
                    $.getJSON('{{route('system.ajax.get')}}?type=first_last_transactions', {
                        'date':$('.datepicker').val(),
                        'merchant_id' : '{{$result->id}}'
                    }, function ($data) {
                        $newData = new Array;
                        $newData.push('<div class="form-group col-sm-6" style="float: left;"><labl>Start Date: <span style="color: green;">'+$data.start+'</span></div>');
                        $newData.push('<div class="form-group col-sm-6" style="float: right;"><labl>End of Day: <span style="color: green;">'+$data.end+'</span></div>');
