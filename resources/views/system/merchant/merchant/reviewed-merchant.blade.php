                ...
                <div class="card-body">
                    <div class="card-block">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <fieldset class="form-group">
                                    {{ Form::label('id',__('Merchant Name')) }}
                                    {!! Form::text('name',null,['class'=>'form-control','id'=>'name']) !!}
                                </fieldset>
                            </div>

                            <div class="col-md-12 {!! formError($errors,'staff_id',true) !!}">
                                @if($sales_data)
                                    <div class="col-md-12{!! formError($errors,'staff_id',true) !!}">
                                        <div class="controls">
                                            {!! Form::label('staff_id', __('Merchant Created By').':') !!}
                                            {!! Form::select('staff_id',array_merge(['0'=>__('Select Staff')],$sales_data),old('staff_id'),['readeonly'=>true],['style'=>'width:100%;']) !!}
                                        </div>
