                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <fieldset class="form-group">
                                    ...
                                    {!! Form::select('is_reseller',[''=>__('Select Is Reseller'),'active'=>__('Yes'),'in-active'=>__('No')],null,['class'=>'form-control','id'=>'is_reseller','rows'=>2]) !!}
                                </fieldset>
                            </div>
                            ...
                            <div class="col-md-12">
                                    <fieldset class="form-group">
                                        {{ Form::label('parent_id',__('Agent')) }}
                                        {!! Form::select('parent_id',[''=>__('Select Agent')],null,['style'=>'width: 100%;' ,'id'=>'merchantSelect2','class'=>'form-control col-md-12']) !!}
                                    </fieldset>
                                </div>
            ...
            <div class="content-header row">
                ...
                <div class="content-header-left col-md-6 col-xs-12">
                    <h4>
                        ...
                        @if(staffCan('download.merchant.excel'))
