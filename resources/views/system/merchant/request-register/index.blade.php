                    ...
                    <div class="card-body">
                        <div class="card-block">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <fieldset class="form-group">
                                        {{ Form::label('is_seen',__('Is Seen')) }}
                                        {!! Form::select('is_seen',[''=>__('Select Is seen'),'yes'=>__('Yes'),'no'=>__('No')],null,['class'=>'form-control','id'=>'is_seen']) !!}
                                    </fieldset>
                                </div>
...
<div class="modal fade text-xs-left" id="modal-data"  role="dialog" aria-labelledby="myModalLabel33" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                ...
                <label class="modal-title text-text-bold-600" id="myModalLabel33">{{__('Visit Data')}}</label>
            </div>
            {!! Form::open(['onsubmit'=> 'updateVisits($(this));return false;','method'=> 'PATCH']) !!}
            <div class="modal-body">

                <div class="card-body">
                    <div class="card-block">
                        <div class="row" id="modal-data-content">
            ...
            <div class="content-header row">
                ...
                <div class="content-header-left col-md-4 col-xs-12">
                    <h4>
                        ...
                        @if(staffCan('download.merchant-request-register.excel'))
...
@section('footer')
    ...
    <script type="text/javascript">
        ...
        function showData($id) {
            ...
            $.get('{{route('merchant.request-register.index')}}/'+$id,function ($data) {
        ...
        $dataTableVar = $('#egpay-datatable').DataTable({
            ...
            "fnPreDrawCallback": function(oSettings) {
                for (var i = 0, iLen = oSettings.aoData.length; i < iLen; i++) {
                    if(oSettings.aoData[i]._aData[4] != ''){
                        oSettings.aoData[i].nTr.className = oSettings.aoData[i]._aData[4];
                    }
                }
            }
