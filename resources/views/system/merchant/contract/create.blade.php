                                        ...
                                        <div class="form-group col-sm-6{!! formError($errors,'merchant_id',true) !!}">
                                            <div class="controls">
                                                ...
                                                @else
                                                    ...
                                                    @if(isset($result->id))
                                                        {!! Form::text('merchant_text', $result->merchant->{'name_'.\DataLanguage::get()}.' #ID: '.$result->merchant->id,['class'=>'form-control','readonly'=>'readonly']) !!}
                                                    @else
                                                ...
                                                <div class="table-responsive">
                                                    ...
                                                    <table class="table">
                                                        ...
                                                        @foreach($result->upload as $key => $value)
                                                            <tr id="upload-file-{{$key}}">
                                                                <th scope="row">{{$key+1}}</th>
                                                                <td><a target="_blank" href="{{asset('/'.$value->path)}}">
                                                                ...
                                                                <td>
                                                                    <a data-tr="upload-file-{{$key}}" class="btn btn-danger imageClass" id="{{$value->id}}" href="javascript:;"  ><i class="fa fa-trash"></i></a>
...
@section('footer')
    ...
    <script>
        ...
        {{--function imageDelete(imageid) {--}}
            {{--var value = imageid;--}}
            {{--$.post("{{route('merchant.merchant.image-delete')}}", {'id':value }, function (data) {--}}
                {{--data.remove();--}}
            {{--});--}}
        {{--}--}}
        ...
        $('.imageClass').click(function(){
            if(confirm('Are You Sure ?')) {
                ...
                $.post("{{route('merchant.merchant.image-delete')}}", {'id': id}, function ($data) {
                    $('#' + DataTR).remove();
                });
            }
        });
