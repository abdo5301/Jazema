                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            {{--<tr>--}}
                                                {{--<td>{{__('Map')}}</td>--}}
                                                {{--<td>--}}
                                                    {{--<a href="javascript:void(0);" onclick="viewMap({{$result->latitude}},{{$result->longitude}},'{{$result->{'name_'.\DataLanguage::get()} }} ( {{$result->merchant->{'name_'.\DataLanguage::get()} }} ) ')">{{__('View')}}</a>--}}
                                                {{--</td>--}}
                                            {{--</tr>--}}
                                            {{--@endif--}}
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{url('system/staff/'.$result->staff_id)}}" target="_blank">
                                                        [{{__('Staff')}}] {{__('#ID')}}:{{$result->staff_id}} <br >{{$result->staff->firstname .' '. $result->staff->lastname}}
                                                    </a>
                                                    @elseif($result->merchant_staff_id)
                                                        <a href="{{route('merchant.staff.show',$result->merchant_staff_id)}}" target="_blank">
                                                            [{{__('Merchant Staff')}}] {{__('#ID')}}:{{$result->merchant_staff->id}} <br >{{$result->merchant_staff->firstname .' '. $result->merchant_staff->lastname}}
                                                        </a>
                                                    @else
                                                        --
                                                    @endif
