                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover">
                                            ...
                                            <tr>
                                                <td>{{__('Merchant')}}</td>
                                                <td>
                                                    <a target="_blank" href="{{route('merchant.category.show',$result->merchant_category->id)}}">
                                                        {{$result->merchant_category->{'name_'.\DataLanguage::get()} }}
                                                    </a>
                                                </td>
                                            </tr>
                                            ...
                                            @if($result->suggested_by_merchant_staff_id)
                                            <tr>
                                                <td>{{__('Suggested By Merchant Staff')}}</td>
                                                <td>
                                                    <a target="_blank" href="{{route('merchant.staff.show',$result->suggested_by_merchant_staff_id)}}">
                                                        {{__('#ID')}}: {{$result->suggested_by_merchant_staff_id}} <br>
                                        ...
                                        <table class="table" id="product-list">
                                                ...
                                                <tr class="treegrid-1">
                                                    <td>
                                                        ...
                                                        @endif
                                                        <b>
                                                            <a  @if($result->approved_at == null) style="color: red;" @endif target="_blank" href="{{route('merchant.category.show',$result->id)}}">{{$result->{'name_'.\DataLanguage::get()} }}</a>
                                                        </b>
                                                    </td>
                                                    <td colspan="2">{{$result->{'description_'.\DataLanguage::get()} }}</td>
                                                </tr>
