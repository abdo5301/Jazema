                ...
                <div class="card-body">
                    <div class="card-block">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <fieldset class="form-group">
                                    {{ Form::label('fromStaffSelect2',__('From Staff')) }}
                                    <div>
                                        {!! Form::select('from_staff_id',[''=>__('Select From Staff')],null,['style'=>'width: 100%;' ,'id'=>'fromStaffSelect2','class'=>'form-control col-md-12']) !!}
                                    </div>
                                </fieldset>
                            </div>
                            ...
                            <div class="col-md-12">
                                <fieldset class="form-group">
                                    {{ Form::label('toStaffSelect2',__('To Staff')) }}
                                    <div>
                                        {!! Form::select('to_staff_id',[''=>__('Select To Staff')],null,['style'=>'width: 100%;' ,'id'=>'toStaffSelect2','class'=>'form-control col-md-12']) !!}
                                    </div>
                                </fieldset>
                            </div>
                            ...
                            <div class="col-md-12">
                                <fieldset class="form-group">
                                    {{ Form::label('byStaffSelect2',__('By Staff')) }}
                                    <div>
                                        {!! Form::select('by_staff_id',[''=>__('Select By Staff')],null,['style'=>'width: 100%;' ,'id'=>'byStaffSelect2','class'=>'form-control col-md-12']) !!}
                                    </div>
                                </fieldset>
                            </div>
                            ...
                            <div class="col-md-12">
                                <fieldset class="form-group">
                                    ...
                                    <div>
                                        {!! Form::select('staff_id',[''=>__('Select Merchant')],null,['style'=>'width: 100%;' ,'id'=>'merchantSelect2','class'=>'form-control col-md-12']) !!}
                                    </div>
                                </fieldset>
                            </div>
...
@section('footer')
    ...
    <script type="text/javascript">
        staffSelect('#fromStaffSelect2');
        staffSelect('#toStaffSelect2');
        staffSelect('#byStaffSelect2');
