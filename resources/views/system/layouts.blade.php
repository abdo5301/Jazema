            ...
            @if(request('without_navbar') == 'true')
                ...
                @else
                    ...
                    <nav class="header-navbar navbar navbar-with-menu navbar-fixed-top navbar-light navbar-border">
                        <div class="navbar-wrapper" style="background: #ffd8c4;">
                            <div class="navbar-header">
                                <ul class="nav navbar-nav">
                                    <li class="nav-item mobile-menu hidden-md-up float-xs-left"><a href="#" class="nav-link nav-menu-main menu-toggle hidden-xs"><i class="ft-menu font-large-1"></i></a></li>
                                    <li class="nav-item"><a href="{{route('system.dashboard')}}" class="navbar-brand"><h2 class="brand-text">Jazeema</h2></a></li>
                    ...
                    <!-- Sender Model -->
                    @if(staffCan('system.encrypt'))
                    <div class="modal fade text-xs-left" id="encrypt-modal"  role="dialog" aria-labelledby="myModalLabel33" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <label class="modal-title text-text-bold-600" id="myModalLabel33">{{__('Encryption')}}</label>
                                </div>
                                {!! Form::open(['id'=>'encrypt-form','method'=>'POST','onsubmit'=>'encryptDataSystem(\''.route('system.encrypt').'\',$(this));return false;']) !!}
                                <div class="modal-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <fieldset class="form-group">
                                                        {{ Form::label('encrypt_type',__('Type')) }}
                                                        {!! Form::select('encrypt_type',['encrypt'=>__('Encrypt'),'decrypt'=>__('Decrypt')],null,['id'=>'encrypt_type','class'=>'form-control']) !!}
                                                ...
                                                <div class="col-md-12">
                                                    <fieldset class="form-group">
                                                        {{ Form::label('encrypt_text',__('Text')) }}
                                                        {!! Form::textarea('encrypt_text',null,['class'=>'form-control','id'=>'encrypt_text']) !!}
                                                ...
                                                <div class="col-md-12">
                                                    <fieldset class="form-group">
                                                        <pre onclick="selectElementText(this);" id="encrypt_OUTPUT"></pre>
                                                    </fieldset>
                                                </div>
                    ...
                    <footer class="footer footer-light navbar-border">
                        <p class="clearfix blue-grey lighten-2 text-sm-center mb-0 px-2">
                            <span class="float-md-left d-xs-block d-md-inline-block">Copyright  &copy; {{date('Y')}} <a href="#" target="_blank" class="text-bold-800 grey darken-2">Jazeema </a>, All rights reserved. </span>
                    ...
                    <script src="{{asset('assets/system/node.js?time=EGPAYTIME')}}" type="text/javascript"></script>
                    <!-- More Footer -->
                    @yield('footer')
                    <!-- More Footer -->
