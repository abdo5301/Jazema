                                    ...
                                    <div class="card-block card-dashboard">
                                        ...
                                        <div class="form-group col-sm-12">
                                            <div class="controls">
                                                ...
                                                <input disabled="disabled" value="{{implode(' -> ',\App\Libs\AreasData::getAreaTypesUp(\App\Models\AreaType::orderByDesc('id')->first()->id,\DataLanguage::get()))}}" class="form-control">
                                            </div>
                                        </div>
