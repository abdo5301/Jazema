                ...
                <div class="card-body">
                    <div class="card-block">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <fieldset class="form-group">
                                    {{ Form::label('id',__('Item Category')) }}
                                    {!! Form::number('item_category_id',null,['class'=>'form-control','id'=>'id']) !!}
                                </fieldset>
                            </div>
                            <div class="col-md-6">
                                <fieldset class="form-group">
                                    {{ Form::label('type',__('Type')) }}
                                    {!! Form::select('type',[''=>'Select Type','text'=>__('Text'),'textarea'=>__('Textarea'),'select'=>__('Select'),'radio'=>__('Radio'),'check'=>__('Check')],null,['class'=>'form-control']) !!}
                                </fieldset>
                            </div>
                            <div class="col-md-12">
                                <fieldset class="form-group">
                                    {{ Form::label('type',__('Status')) }}
                                    {!! Form::select('status',[''=>'Select status','active'=>__('Active'),'in-active'=>__('In-active')],null,['class'=>'form-control']) !!}
                                </fieldset>
                            </div>
                            <div class="col-md-12">
                                <fieldset class="form-group">
                                    {{ Form::label('is_required',__('Is Required')) }}
                                    {!! Form::select('is_required',[''=>'Select','yes'=>__('Yes'),'no'=>__('No')],null,['class'=>'form-control']) !!}
                                </fieldset>
                            </div>
                            {{--<div class="col-md-12">--}}
                                {{--<fieldset class="form-group">--}}
                                    ...
                                    {{--<div>--}}
                                        {{--{!! Form::select('merchant_id',[''=>__('Select Merchant')],null,['style'=>'width: 100%;' ,'id'=>'merchant_id','class'=>'form-control col-md-12']) !!}--}}
                                    {{--</div>--}}
                                {{--</fieldset>--}}
                            {{--</div>--}}
