                                        ...
                                        @if(isset($area_type))
                                            <div class="form-group col-sm-12">
                                                <div class="controls">
                                                    ...
                                                    <input disabled="disabled" value="{{implode(' -> ',\App\Libs\AreasData::getAreaTypesUp($area_type->id,\DataLanguage::get()))}}" class="form-control">
                                                </div>
                                            </div>
                                            {!! Form::hidden('area_type_id',$area_type->id) !!}
                                        @endif
                                        ...
                                        @if(isset($area))
                                            <div class="form-group col-sm-12">
                                                <div class="controls">
                                                    ...
                                                    <input disabled="disabled" value="{{implode(' -> ',\App\Libs\AreasData::getAreasUp($area->id,\DataLanguage::get()))}}" class="form-control">
                                                </div>
                                            </div>
