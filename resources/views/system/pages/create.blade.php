                ...
                <section id="server-processing">
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            @endif
                            {!! Form::open(['route' => isset($result->id) ? ['system.pages.update',$result->id]:'system.pages.store','method' => isset($result->id) ?  'PATCH' : 'POST','files' => true]) !!}
                            <div class="col-sm-6">
                                <div class="card">
                                        ...
                                        <div class="card-block card-dashboard">
                                            <div class="form-group col-sm-12{!! formError($errors,'content_en',true) !!}">
                                                <div class="controls">
                                                    ...
                                                    {!! Form::textarea('content_en',isset($result->id) ? $result->content_en:old('content_en'),['class'=>'form-control summernote']) !!}
                                                </div>
                                        ...
                                        <div class="card-block card-dashboard">
                                            <div class="form-group col-sm-12{!! formError($errors,'content_ar',true) !!}">
                                                <div class="controls">
                                                    ...
                                                    {!! Form::textarea('content_ar',isset($result->id) ? $result->content_ar:old('content_ar'),['class'=>'form-control summernote ']) !!}
                                                </div>
