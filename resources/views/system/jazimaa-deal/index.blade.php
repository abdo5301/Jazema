                ...
                <div class="card-body">
                    <div class="card-block">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <fieldset class="form-group">
                                    {{ Form::label('total_price1',__('total_price From')) }}
                                    {!! Form::number('total_price1',null,['class'=>'form-control','id'=>'total_price1']) !!}
                                </fieldset>
                            </div>    
                            <div class="col-md-12">
                                <fieldset class="form-group">
                                    {{ Form::label('total_price',__('Total Price To')) }}
                            ...
                            <div class="col-md-12">
                                <fieldset class="form-group">
                                    ...
                                    {!! Form::select('item_id',[''=>__('Select Item')],null,['style'=>'width: 100%;' ,'id'=>'item_id','class'=>'form-control col-md-12']) !!}
                                </fieldset>
                            </div>
                            <div class="col-md-12">
                                <fieldset class="form-group">
                                    {{ Form::label('item_owner_id',__('Owner')) }}
                                    {!! Form::select('item_owner_id',[''=>__('Select Owner')],null,['style'=>'width: 100%;' ,'id'=>'item_owner_id','class'=>'form-control col-md-12']) !!}
                                </fieldset>
                            </div>
                     <div class="col-md-12">
                                <fieldset class="form-group">
                                    {{ Form::label('status',__('Status')) }}
                                    {!! Form::select('status',[__('Select Status'),'pending'=>__('Pending'),'inprogress'=>__('Inprogress'),'stopping'=>__('Stopping'),'pause'=>__('Pause')],null,['class'=>'form-control']) !!}
                                </fieldset>
                            </div>
